...
function ContextMenuContent({
  className,
  ...props
}: ContextMenuPrimitive.Popup.Props & Partial<ContextMenuPrimitive.Positioner.Props>) {
  return (
    <ContextMenuPrimitive.Portal>
      <ContextMenuPrimitive.Positioner className="isolate z-50 outline-none">
        <ContextMenuPrimitive.Popup
          ...
          className={cn(
            "z-50 min-w-32 overflow-hidden rounded-lg bg-popover p-1 text-popover-foreground shadow-lg ring-1 ring-foreground/10 duration-100 outline-none",
